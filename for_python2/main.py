...
from models import gensim_summarizer, sumy_Lex_summarize, sumy_LsaSummarizer_summarizer, \
    sumy_Luhn_summarize, pyteaser_summarizer, pytldr_LSA_summarizer, pytldr_textRank_summarizer
...
pyteaser_summary = pyteaser_summarizer.pyteaser_summary(title, text,SENTENCES_COUNT)
pytldr_text_rank_summary = pytldr_textRank_summarizer.pytldr_textrank(text)
pytldr_lsa_summary = pytldr_LSA_summarizer.pytldr_lsa(text)
